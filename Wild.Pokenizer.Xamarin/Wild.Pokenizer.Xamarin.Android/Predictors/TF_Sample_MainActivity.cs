...
{
    //From https://github.com/lobrien/TensorFlow.Xamarin.Android/blob/master/TensorFlowXamarin/Hello_TF/MainActivity.cs
    ...
    public class TF_Sample_MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            try
            {
                ...
                var INPUT_ARGUMENT_NAME = "lstm_1_input";
                var OUTPUT_VARIABLE_NAME = "output_node0";
                var OUTPUT_SIZE = 100;

                tfi.Feed(INPUT_ARGUMENT_NAME, inputSeaLevels, inputSeaLevels.Length, 1, 1);
                tfi.Run(new String[] { OUTPUT_VARIABLE_NAME });
                var predictions = new float[OUTPUT_SIZE];
